...
lib.makeScope newScope (self: with self; {
  ...
  appres = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto, libXt }: stdenv.mkDerivation {
      name = "appres-1.0.5";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  bdftopcf = callPackage
    ({ stdenv, pkgconfig, fetchurl }: stdenv.mkDerivation {
      name = "bdftopcf-1.1";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  bitmap = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXaw, xbitmaps, libXmu, xorgproto, libXt }: stdenv.mkDerivation {
      name = "bitmap-1.0.9";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  editres = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXaw, libXmu, xorgproto, libXt }: stdenv.mkDerivation {
      name = "editres-1.0.7";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  fontadobe100dpi = callPackage
    ({ stdenv, pkgconfig, fetchurl, bdftopcf, fontutil, mkfontscale }: stdenv.mkDerivation {
  ...
  fontadobeutopiatype1 = callPackage
    ({ stdenv, pkgconfig, fetchurl, mkfontscale }: stdenv.mkDerivation {
  ...
  fontarabicmisc = callPackage
    ({ stdenv, pkgconfig, fetchurl, bdftopcf, mkfontscale }: stdenv.mkDerivation {
  ...
  fonttosfnt = callPackage
    ({ stdenv, pkgconfig, fetchurl, libfontenc, freetype, xorgproto }: stdenv.mkDerivation {
  ...
  iceauth = callPackage
    ({ stdenv, pkgconfig, fetchurl, libICE, xorgproto }: stdenv.mkDerivation {
      name = "iceauth-1.0.8";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  ico = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto }: stdenv.mkDerivation {
      name = "ico-1.0.5";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  imake = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto }: stdenv.mkDerivation {
      name = "imake-1.0.8";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libAppleWM = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXext }: stdenv.mkDerivation {
  ...
  libFS = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, xtrans }: stdenv.mkDerivation {
      name = "libFS-1.0.8";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libSM = callPackage
    ({ stdenv, pkgconfig, fetchurl, libICE, libuuid, xorgproto, xtrans }: stdenv.mkDerivation {
      name = "libSM-1.2.3";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libX11 = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libxcb, xtrans }: stdenv.mkDerivation {
      name = "libX11-1.7.0";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libXTrap = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXext, libXt }: stdenv.mkDerivation {
      name = "libXTrap-1.0.1";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libXaw = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXext, xorgproto, libXmu, libXpm, libXt }: stdenv.mkDerivation {
      name = "libXaw-1.0.13";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libXaw3d = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXext, libXmu, libXpm, xorgproto, libXt }: stdenv.mkDerivation {
      name = "libXaw3d-1.6.3";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libXcomposite = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXfixes }: stdenv.mkDerivation {
  ...
  libXcursor = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXfixes, libXrender }: stdenv.mkDerivation {
  ...
  libXfixes = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11 }: stdenv.mkDerivation {
  ...
  libXfont = callPackage
    ({ stdenv, pkgconfig, fetchurl, libfontenc, xorgproto, freetype, xtrans, zlib }: stdenv.mkDerivation {
      name = "libXfont-1.5.4";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libXft = callPackage
    ({ stdenv, pkgconfig, fetchurl, fontconfig, freetype, libX11, xorgproto, libXrender }: stdenv.mkDerivation {
      name = "libXft-2.3.3";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libXi = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXext, libXfixes }: stdenv.mkDerivation {
      name = "libXi-1.7.10";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libXinerama = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXext, xorgproto }: stdenv.mkDerivation {
  ...
  libXmu = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXext, xorgproto, libXt }: stdenv.mkDerivation {
      name = "libXmu-1.1.3";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libXp = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXau, libXext }: stdenv.mkDerivation {
      name = "libXp-1.0.3";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libXpm = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXext, xorgproto, libXt, gettext }: stdenv.mkDerivation {
      name = "libXpm-3.5.13";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libXrandr = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXext, libXrender }: stdenv.mkDerivation {
  ...
  libXt = callPackage
    ({ stdenv, pkgconfig, fetchurl, libICE, xorgproto, libSM, libX11 }: stdenv.mkDerivation {
      name = "libXt-1.2.0";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libXtst = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXext, libXi }: stdenv.mkDerivation {
      name = "libXtst-1.2.3";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libXvMC = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXext, libXv }: stdenv.mkDerivation {
      name = "libXvMC-1.0.12";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  libfontenc = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, zlib }: stdenv.mkDerivation {
  ...
  libpciaccess = callPackage
    ({ stdenv, pkgconfig, fetchurl, zlib }: stdenv.mkDerivation {
  ...
  libxcb = callPackage
    ({ stdenv, pkgconfig, fetchurl, libxslt, libpthreadstubs, libXau, xcbproto, libXdmcp, python3 }: stdenv.mkDerivation {
      name = "libxcb-1.14";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  listres = callPackage
    ({ stdenv, pkgconfig, fetchurl, libXaw, libXmu, xorgproto, libXt }: stdenv.mkDerivation {
      name = "listres-1.0.4";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  mkfontscale = callPackage
    ({ stdenv, pkgconfig, fetchurl, libfontenc, freetype, xorgproto, zlib }: stdenv.mkDerivation {
  ...
  oclock = callPackage
    ({ stdenv, pkgconfig, fetchurl, libxkbfile, libX11, libXext, libXmu, libXt }: stdenv.mkDerivation {
      name = "oclock-1.0.4";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  setxkbmap = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libxkbfile }: stdenv.mkDerivation {
  ...
  smproxy = callPackage
    ({ stdenv, pkgconfig, fetchurl, libICE, libSM, libXmu, libXt }: stdenv.mkDerivation {
      name = "smproxy-1.0.6";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  twm = callPackage
    ({ stdenv, pkgconfig, fetchurl, libICE, libSM, libX11, libXext, libXmu, xorgproto, libXt }: stdenv.mkDerivation {
      name = "twm-1.0.10";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  viewres = callPackage
    ({ stdenv, pkgconfig, fetchurl, libXaw, libXmu, libXt }: stdenv.mkDerivation {
      name = "viewres-1.0.5";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  x11perf = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXext, libXft, libXmu, xorgproto, libXrender }: stdenv.mkDerivation {
      name = "x11perf-1.6.1";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xauth = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXau, libXext, libXmu, xorgproto }: stdenv.mkDerivation {
      name = "xauth-1.1";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xbacklight = callPackage
    ({ stdenv, pkgconfig, fetchurl, libxcb, xcbutil }: stdenv.mkDerivation {
  ...
  xcalc = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXaw, xorgproto, libXt }: stdenv.mkDerivation {
      name = "xcalc-1.1.0";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xcbproto = callPackage
    ({ stdenv, pkgconfig, fetchurl, python3 }: stdenv.mkDerivation {
  ...
  xcbutil = callPackage
    ({ stdenv, pkgconfig, fetchurl, gperf, libxcb, xorgproto, m4 }: stdenv.mkDerivation {
      name = "xcb-util-0.4.0";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xcbutilcursor = callPackage
    ({ stdenv, pkgconfig, fetchurl, gperf, libxcb, xcbutilimage, xcbutilrenderutil, xorgproto, m4 }: stdenv.mkDerivation {
  ...
  xcbutilerrors = callPackage
    ({ stdenv, pkgconfig, fetchurl, gperf, libxcb, xcbproto, xorgproto, m4 }: stdenv.mkDerivation {
  ...
  xcbutilimage = callPackage
    ({ stdenv, pkgconfig, fetchurl, gperf, libxcb, xcbutil, xorgproto, m4 }: stdenv.mkDerivation {
  ...
  xclock = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXaw, libXft, libxkbfile, libXmu, xorgproto, libXrender, libXt }: stdenv.mkDerivation {
      name = "xclock-1.0.9";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xcmsdb = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11 }: stdenv.mkDerivation {
      name = "xcmsdb-1.0.5";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xcompmgr = callPackage
    ({ stdenv, pkgconfig, fetchurl, libXcomposite, libXdamage, libXext, libXfixes, libXrender }: stdenv.mkDerivation {
      name = "xcompmgr-1.1.8";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xcursorgen = callPackage
    ({ stdenv, pkgconfig, fetchurl, libpng, libX11, libXcursor }: stdenv.mkDerivation {
  ...
  xcursorthemes = callPackage
    ({ stdenv, pkgconfig, fetchurl, libXcursor }: stdenv.mkDerivation {
  ...
  xdm = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXau, libXaw, libXdmcp, libXext, libXft, libXinerama, libXmu, libXpm, xorgproto, libXrender, libXt }: stdenv.mkDerivation {
      name = "xdm-1.1.12";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xdpyinfo = callPackage
    ({ stdenv, pkgconfig, fetchurl, libdmx, libX11, libxcb, libXcomposite, libXext, libXi, libXinerama, xorgproto, libXrender, libXtst, libXxf86dga, libXxf86misc, libXxf86vm }: stdenv.mkDerivation {
      name = "xdpyinfo-1.3.2";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xdriinfo = callPackage
    ({ stdenv, pkgconfig, fetchurl, libGL, xorgproto, libX11 }: stdenv.mkDerivation {
      name = "xdriinfo-1.0.6";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xev = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto, libXrandr }: stdenv.mkDerivation {
      name = "xev-1.2.3";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xeyes = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXext, libXmu, xorgproto, libXrender, libXt }: stdenv.mkDerivation {
      name = "xeyes-1.1.2";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xf86inputevdev = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libevdev, udev, mtdev, xorgserver }: stdenv.mkDerivation {
  ...
  xf86inputjoystick = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, xorgserver }: stdenv.mkDerivation {
  ...
  xf86inputlibinput = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libinput, xorgserver }: stdenv.mkDerivation {
  ...
  xf86inputsynaptics = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libevdev, libX11, libXi, xorgserver, libXtst }: stdenv.mkDerivation {
  ...
  xf86inputvmmouse = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, udev, xorgserver }: stdenv.mkDerivation {
  ...
  xf86inputvoid = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgserver, xorgproto }: stdenv.mkDerivation {
  ...
  xf86videoamdgpu = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, mesa, libGL, libdrm, udev, xorgserver }: stdenv.mkDerivation {
  ...
  xf86videoapm = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libpciaccess, xorgserver }: stdenv.mkDerivation {
  ...
  xf86videoati = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, mesa, libGL, libdrm, udev, libpciaccess, xorgserver }: stdenv.mkDerivation {
  ...
  xf86videoglint = callPackage
    ({ stdenv, pkgconfig, fetchurl, libpciaccess, xorgproto, xorgserver }: stdenv.mkDerivation {
  ...
  xf86videointel = callPackage
    ({ stdenv, pkgconfig, fetchurl, cairo, xorgproto, libdrm, libpng, udev, libpciaccess, libX11, xcbutil, libxcb, libXcursor, libXdamage, libXext, libXfixes, xorgserver, libXrandr, libXrender, libxshmfence, libXtst, libXvMC }: stdenv.mkDerivation {
  ...
  xf86videomach64 = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libdrm, libpciaccess, xorgserver }: stdenv.mkDerivation {
  ...
  xf86videonouveau = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libdrm, udev, libpciaccess, xorgserver }: stdenv.mkDerivation {
  ...
  xf86videoomap = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libdrm, xorgserver }: stdenv.mkDerivation {
  ...
  xf86videoopenchrome = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libdrm, udev, libpciaccess, libX11, libXext, xorgserver, libXvMC }: stdenv.mkDerivation {
  ...
  xf86videovmware = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libdrm, udev, libpciaccess, libX11, libXext, xorgserver }: stdenv.mkDerivation {
  ...
  xfd = callPackage
    ({ stdenv, pkgconfig, fetchurl, libxkbfile, fontconfig, libXaw, libXft, libXmu, xorgproto, libXrender, libXt, gettext }: stdenv.mkDerivation {
      name = "xfd-1.1.3";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xfontsel = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXaw, libXmu, libXt }: stdenv.mkDerivation {
      name = "xfontsel-1.0.6";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xfs = callPackage
    ({ stdenv, pkgconfig, fetchurl, libXfont2, xorgproto, xtrans }: stdenv.mkDerivation {
      name = "xfs-1.2.0";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xfsinfo = callPackage
    ({ stdenv, pkgconfig, fetchurl, libFS, xorgproto }: stdenv.mkDerivation {
      name = "xfsinfo-1.0.6";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xgamma = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto, libXxf86vm }: stdenv.mkDerivation {
      name = "xgamma-1.0.6";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xgc = callPackage
    ({ stdenv, pkgconfig, fetchurl, libXaw, libXt }: stdenv.mkDerivation {
      name = "xgc-1.0.5";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xhost = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXau, libXmu, xorgproto }: stdenv.mkDerivation {
      name = "xhost-1.0.8";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xinput = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXext, libXi, libXinerama, libXrandr }: stdenv.mkDerivation {
      name = "xinput-1.6.3";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xkbcomp = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libxkbfile, xorgproto }: stdenv.mkDerivation {
      name = "xkbcomp-1.4.2";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xkbutils = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, libX11, libXaw, libXt }: stdenv.mkDerivation {
      name = "xkbutils-1.0.4";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xkeyboardconfig = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto, python3 }: stdenv.mkDerivation {
  ...
  xkill = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXmu, xorgproto }: stdenv.mkDerivation {
      name = "xkill-1.0.5";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xload = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXaw, libXmu, xorgproto, libXt, gettext }: stdenv.mkDerivation {
      name = "xload-1.1.3";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xlsatoms = callPackage
    ({ stdenv, pkgconfig, fetchurl, libxcb }: stdenv.mkDerivation {
      name = "xlsatoms-1.1.3";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xorgproto = callPackage
    ({ stdenv, pkgconfig, fetchurl, libXt }: stdenv.mkDerivation {
  ...
  xorgserver = callPackage
    ({ stdenv, pkgconfig, fetchurl, xorgproto, openssl, libX11, libXau, libXaw, libxcb, xcbutil, xcbutilwm, xcbutilimage, xcbutilkeysyms, xcbutilrenderutil, libXdmcp, libXfixes, libxkbfile, libXmu, libXpm, libXrender, libXres, libXt }: stdenv.mkDerivation {
  ...
  xrandr = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto, libXrandr, libXrender }: stdenv.mkDerivation {
      name = "xrandr-1.5.1";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xset = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXext, libXmu, xorgproto, libXxf86misc }: stdenv.mkDerivation {
      name = "xset-1.2.4";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xsetroot = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, xbitmaps, libXcursor, libXmu, xorgproto }: stdenv.mkDerivation {
      name = "xsetroot-1.1.2";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xsm = callPackage
    ({ stdenv, pkgconfig, fetchurl, libICE, libSM, libX11, libXaw, libXt }: stdenv.mkDerivation {
      name = "xsm-1.0.4";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xtrap = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libXt, libXTrap }: stdenv.mkDerivation {
      name = "xtrap-1.0.3";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xvinfo = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, xorgproto, libXv }: stdenv.mkDerivation {
      name = "xvinfo-1.1.4";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xwd = callPackage
    ({ stdenv, pkgconfig, fetchurl, libxkbfile, libX11, xorgproto }: stdenv.mkDerivation {
      name = "xwd-1.0.7";
      builder = ./builder.sh;
      src = fetchurl {
  ...
  xwininfo = callPackage
    ({ stdenv, pkgconfig, fetchurl, libX11, libxcb, xorgproto }: stdenv.mkDerivation {
      name = "xwininfo-1.1.4";
      builder = ./builder.sh;
      src = fetchurl {
