...
let
  ...
  versionRange = min-version: upto-version:
    ...
    in
    if versionAtLeast ungoogled-version upto-version
    then
      warn "chromium: ungoogled version ${ungoogled-version} is newer than a patchset bounded at ${upto-version}. You can safely delete it."
        result
    else result;
