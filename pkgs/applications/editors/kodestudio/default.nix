...
let
  ...
  sha256 =
    if stdenv.hostPlatform.system == "x86_64-linux" then "1kddisnvlk48jip6k59mw3wlkrl7rkck2lxpaghn0gfx02cvms5f"
  ...
  urlStr =
    if stdenv.hostPlatform.system == "x86_64-linux" then urlBase + "linux64.tar.gz"
