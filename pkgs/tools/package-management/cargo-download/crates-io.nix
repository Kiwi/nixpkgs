...
rec {
  ...
  features_.arrayvec."0.4.8" = deps: f: updateFeatures f
    (rec {
  ...
  features_.bitflags."0.9.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.byteorder."1.1.0" = deps: f: updateFeatures f
    (rec {
  ...
  features_.bytes."0.4.11" = deps: f: updateFeatures f
    (rec {
      byteorder = fold recursiveUpdate { } [
        {
  ...
  features_.cc."1.0.3" = deps: f: updateFeatures f
    (rec {
  ...
  features_.clap."2.27.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.cloudabi."0.0.3" = deps: f: updateFeatures f
    (rec {
  ...
  features_.core_foundation."0.5.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.crossbeam_epoch."0.6.1" = deps: f: updateFeatures f
    (rec {
      arrayvec = fold recursiveUpdate { } [
        {
  ...
  features_.crossbeam_utils."0.6.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.custom_derive."0.1.7" = deps: f: updateFeatures f
    (rec {
  ...
  features_.either."1.4.0" = deps: f: updateFeatures f
    (rec {
  ...
  features_.encoding_rs."0.8.13" = deps: f: updateFeatures f
    (rec {
  ...
  features_.flate2."0.2.20" = deps: f: updateFeatures f
    (rec {
  ...
  features_.futures."0.1.25" = deps: f: updateFeatures f
    (rec {
  ...
  features_.futures_cpupool."0.1.7" = deps: f: updateFeatures f
    (rec {
      futures = fold recursiveUpdate { } [
  ...
  features_.httparse."1.2.3" = deps: f: updateFeatures f
    (rec {
  ...
  features_.hyper."0.12.16" = deps: f: updateFeatures f
    (rec {
  ...
  features_.hyper_tls."0.3.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.indexmap."1.0.2" = deps: f: updateFeatures f
    (rec {
  ...
  features_.itoa."0.4.3" = deps: f: updateFeatures f
    (rec {
  ...
  features_.lazy_static."0.2.10" = deps: f: updateFeatures f
    (rec {
  ...
  features_.lazy_static."1.2.0" = deps: f: updateFeatures f
    (rec {
      lazy_static = fold recursiveUpdate { } [
        {
          "1.2.0"."spin" =
  ...
  features_.lazycell."1.2.0" = deps: f: updateFeatures f
    (rec {
  ...
  features_.libc."0.2.44" = deps: f: updateFeatures f
    (rec {
  ...
  features_.log."0.3.8" = deps: f: updateFeatures f
    (rec {
  ...
  features_.mio."0.6.16" = deps: f: updateFeatures f
    (rec {
  ...
  crates.native_tls."0.2.2" = deps: { features ? (features_.native_tls."0.2.2" deps { }) }: buildRustCrate {
    ...
    dependencies = (if kernel == "darwin" || kernel == "ios" then
      mapFeatures features
        ([
    ...
    ++ (if !(kernel == "windows" || kernel == "darwin" || kernel == "ios") then
      mapFeatures features
        ([
  ...
  crates.net2."0.2.33" = deps: { features ? (features_.net2."0.2.33" deps { }) }: buildRustCrate {
    ...
    ++ (if kernel == "redox" || (kernel == "linux" || kernel == "darwin") then
      mapFeatures features
        ([
  ...
  features_.net2."0.2.33" = deps: f: updateFeatures f
    (rec {
  ...
  features_.nodrop."0.1.13" = deps: f: updateFeatures f
    (rec {
  ...
  features_.num."0.1.40" = deps: f: updateFeatures f
    (rec {
  ...
  features_.openssl."0.10.15" = deps: f: updateFeatures f
    (rec {
  ...
  features_.openssl_sys."0.9.39" = deps: f: updateFeatures f
    (rec {
  ...
  features_.parking_lot."0.6.4" = deps: f: updateFeatures f
    (rec {
  ...
  features_.parking_lot_core."0.3.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.phf."0.7.21" = deps: f: updateFeatures f
    (rec {
  ...
  features_.rand."0.3.18" = deps: f: updateFeatures f
    (rec {
  ...
  features_.rand."0.5.5" = deps: f: updateFeatures f
    (rec {
  ...
  features_.rand."0.6.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.rand_core."0.2.2" = deps: f: updateFeatures f
    (rec {
      rand_core = fold recursiveUpdate { } [
        {
  ...
  features_.rand_core."0.3.0" = deps: f: updateFeatures f
    (rec {
      rand_core = fold recursiveUpdate { } [
        {
          "0.3.0"."alloc" =
  ...
  features_.rand_isaac."0.1.1" = deps: f: updateFeatures f
    (rec {
      rand_core = fold recursiveUpdate { } [
        {
  ...
  features_.rand_pcg."0.1.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.rand_xorshift."0.1.0" = deps: f: updateFeatures f
    (rec {
  ...
  features_.regex."0.1.80" = deps: f: updateFeatures f
    (rec {
  ...
  features_.reqwest."0.9.5" = deps: f: updateFeatures f
    (rec {
  ...
  features_.safemem."0.3.0" = deps: f: updateFeatures f
    (rec {
  ...
  features_.scopeguard."0.3.3" = deps: f: updateFeatures f
    (rec {
  ...
  features_.security_framework."0.2.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.security_framework_sys."0.2.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.semver."0.9.0" = deps: f: updateFeatures f
    (rec {
  ...
  features_.serde."1.0.21" = deps: f: updateFeatures f
    (rec {
  ...
  features_.serde_json."1.0.6" = deps: f: updateFeatures f
    (rec {
  ...
  features_.slog."1.7.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.smallvec."0.6.7" = deps: f: updateFeatures f
    (rec {
  ...
  features_.stable_deref_trait."1.1.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.tar."0.4.13" = deps: f: updateFeatures f
    (rec {
  ...
  features_.unicase."1.4.2" = deps: f: updateFeatures f
    (rec {
  ...
  features_.unicode_bidi."0.3.4" = deps: f: updateFeatures f
    (rec {
  ...
  features_.url."1.6.0" = deps: f: updateFeatures f
    (rec {
  ...
  features_.uuid."0.7.1" = deps: f: updateFeatures f
    (rec {
  ...
  features_.vec_map."0.8.0" = deps: f: updateFeatures f
    (rec {
  ...
  features_.xattr."0.1.11" = deps: f: updateFeatures f
    (rec {
